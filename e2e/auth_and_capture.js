...
async function runComprehensiveVisualAudit() {
  ...
  try {
    ...
    // Seed session in localStorage with sample local scans
    ...
    await driver.get('http://localhost:5173/');
    await driver.wait(until.elementLocated(By.css('.site-header')), 5000);
    ...
    console.log('\n========================================');
    console.log(' ALL VISUAL AUDIT SCREENSHOTS CAPTURED');
    console.log('========================================');
  } catch (err) {
