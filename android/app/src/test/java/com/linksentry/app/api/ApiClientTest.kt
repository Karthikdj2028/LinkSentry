...
class ApiClientTest {
    ...
    fun testBaseUrlConfigurationAndSanitization() {
        ...
        val sanitizedNoProto = ApiClient.sanitizeUrl("192.168.29.123:8000")
        assertEquals("http://192.168.29.123:8000/", sanitizedNoProto)

        // Test URL without trailing slash
        val sanitizedNoSlash = ApiClient.sanitizeUrl("http://192.168.29.123:8000")
        assertEquals("http://192.168.29.123:8000/", sanitizedNoSlash)
        ...
        ApiClient.setBaseUrl("http://192.168.29.123:8000", persist = false)
        assertEquals("http://192.168.29.123:8000/", ApiClient.getBaseUrl())
    ...
    fun testPresetsConstants() {
        ...
        assertEquals("http://192.168.29.123:8000/", ApiClient.DEFAULT_LAN_BASE_URL)
    }
}
